...
const Services: React.FC = () => {
  return (
    <>
      <section class="relative py-24 lg:py-16 overflow-hidden bg-gradient-to-r from-orange-400 to-red-300 sm:h-[550px] lg:h-[450px]">
        <div class="absolute inset-0 "></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 class="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
            Innovative Solutions
            <span class="block text-3xl md:text-5xl mt-2 font-normal">
          ...
          <div class="flex flex-col sm:flex-row gap-6 justify-center">
            <button class="inline-flex items-center justify-center gap-2 whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 h-11 rounded-md bg-white text-orange-600 hover:bg-orange-100 px-10 py-4 text-lg font-semibold shadow-lg">
              Explore Solutions
              <svg
